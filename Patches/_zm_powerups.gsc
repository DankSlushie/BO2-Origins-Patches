...
randomize_powerups() //checked matches cerberus output
{
	if (level.round_number >= 16) {
		...
		// ending drop cycle
        	swapPowerupToIndex("zombie_blood", 0);
        	swapPowerupToIndex("insta_kill", 1);
        	swapPowerupToIndex("double_points", 2);
		swapPowerupToIndex("nuke", 3);
        	swapPowerupToIndex("full_ammo", 4);

	} else if (level.round_number >= 2) {

		// default drop cycle
        	swapPowerupToIndex("full_ammo", 0);
        	swapPowerupToIndex("zombie_blood", 1);
        	swapPowerupToIndex("insta_kill", 2);
        	swapPowerupToIndex("double_points", 3);
		swapPowerupToIndex("nuke", 4);
	} else {

		// first drop cycle
        	swapPowerupToIndex("insta_kill", 0);
        	swapPowerupToIndex("full_ammo", 1);
        	swapPowerupToIndex("zombie_blood", 2);
		swapPowerupToIndex("nuke", 3);
        	swapPowerupToIndex("double_points", 4);
	}
